...
<a name="missing-git-submodules"></a>**NOTE**: Do not download the `v7.1.0.tar.gz` from [https://github.com/cp2k/cp2k/releases](https://github.com/cp2k/cp2k/releases) package which was automatically generated by GitHub (it misses the source code from Git-submodules).
